...
from blind.scene_builder import build_scene_description     # Converts YOLO results into human-readable scene text
from blind.speaker import speak, wait_for_speech            # TTS — speaks the LLM description aloud
